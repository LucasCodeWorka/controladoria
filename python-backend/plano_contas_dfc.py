...
PLANO_CONTAS_DFC = [
    {
        ...
        'subgrupos': [
            ...
            {'codigo': 'OP.02', 'nome': 'DESPESAS COM FOLHA'},
            {'codigo': 'OP.03', 'nome': 'CUSTOS COM FOLHA OPERACIONAL'},
            {'codigo': 'OP.04', 'nome': 'DESPESAS COM PESSOAL ADMINISTRAÇÃO E LOJAS'},
            {'codigo': 'OP.05', 'nome': 'DESPESAS ADMINISTRATIVAS'},
            {'codigo': 'OP.06', 'nome': 'DESPESAS COM MARKETING'},
            {'codigo': 'OP.07', 'nome': 'DESPESAS COM VENDAS'},
            {'codigo': 'OP.08', 'nome': 'GASTOS GERAIS DE FABRICAÇÃO'},
            {'codigo': 'OP.09', 'nome': 'DESPESAS FINANCEIRAS'},
            {'codigo': 'OP.10', 'nome': 'IMPOSTOS SOBRE VENDAS'},
            {'codigo': 'OP.11', 'nome': 'DESPESAS COM OCUPAÇÃO'},
            {'codigo': 'OP.12', 'nome': 'DESPESAS BANCÁRIAS'},
            {'codigo': 'OP.13', 'nome': 'DESPESAS COM DIRETORIA'},
            {'codigo': 'OP.14', 'nome': 'DESPESAS SOBRE LUCRO'},
            {'codigo': 'OP.15', 'nome': 'DESPESAS COM VEÍCULOS'},
            {'codigo': 'OP.16', 'nome': 'DESPESAS COMERCIAIS'},
            {'codigo': 'OP.17', 'nome': 'CUSTOS COM IMPOSTOS DIRETOS'},
            {'codigo': 'OP.18', 'nome': 'ENDIVIDAMENTO TRIBUTÁRIO'},
            {'codigo': 'OP.19', 'nome': 'DESPESAS COM CRÉDITO E COBRANÇA'},
            {'codigo': 'OP.20', 'nome': 'DESPESAS COM MANUTENÇÃO'},
            {'codigo': 'OP.21', 'nome': 'DESPESAS COM DEPRECIAÇÃO'},
            {'codigo': 'OP.22', 'nome': 'DEVOLUÇÕES'},
            {'codigo': 'OP.23', 'nome': 'DESPESAS COM PERDAS'},
            {'codigo': 'OP.24', 'nome': 'OFICINAS'},
        ],
    },
    {
        'codigo': 'INV',

...
from routers import health, indicadores, dre, classificacao, analise_executiva, cmv_detalhado, giro, estoque_tempo, foto
...
app.include_router(analise_executiva.router)
app.include_router(cmv_detalhado.router)
